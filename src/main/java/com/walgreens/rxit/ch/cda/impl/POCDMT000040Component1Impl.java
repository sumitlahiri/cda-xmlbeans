 ...
 */
public class POCDMT000040Component1Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Component1
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040Component1Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ENCOMPASSINGENCOUNTER$6 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "encompassingEncounter");
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040EncompassingEncounter getEncompassingEncounter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040EncompassingEncounter target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040EncompassingEncounter)get_store().find_element_user(ENCOMPASSINGENCOUNTER$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEncompassingEncounter(com.walgreens.rxit.ch.cda.POCDMT000040EncompassingEncounter encompassingEncounter)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040EncompassingEncounter)get_store().add_element_user(ENCOMPASSINGENCOUNTER$6);
            }
            target.set(encompassingEncounter);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040EncompassingEncounter addNewEncompassingEncounter()
    {
        synchronized (monitor())
        {
            check_orphaned();
