 ...
 */
public class POCDMT000040LegalAuthenticatorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040LegalAuthenticator
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040LegalAuthenticatorImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SIGNATURECODE$8 = 
    ...
    public com.walgreens.rxit.ch.cda.TS getTime()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.TS)get_store().find_element_user(TIME$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setTime(com.walgreens.rxit.ch.cda.TS time)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.TS)get_store().add_element_user(TIME$6);
            }
            target.set(time);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.CS getSignatureCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.CS target = null;
            target = (com.walgreens.rxit.ch.cda.CS)get_store().find_element_user(SIGNATURECODE$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSignatureCode(com.walgreens.rxit.ch.cda.CS signatureCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.CS)get_store().add_element_user(SIGNATURECODE$8);
            }
            target.set(signatureCode);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.CS addNewSignatureCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
