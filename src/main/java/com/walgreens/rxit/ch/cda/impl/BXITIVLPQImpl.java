 ...
 */
public class BXITIVLPQImpl extends com.walgreens.rxit.ch.cda.impl.IVLPQImpl implements com.walgreens.rxit.ch.cda.BXITIVLPQ
{
    private static final long serialVersionUID = 1L;
    
    public BXITIVLPQImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
