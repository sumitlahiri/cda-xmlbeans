 ...
 */
public class AdxpHouseNumberNumericImpl extends com.walgreens.rxit.ch.cda.impl.ADXPImpl implements com.walgreens.rxit.ch.cda.AdxpHouseNumberNumeric
{
    private static final long serialVersionUID = 1L;
    
    public AdxpHouseNumberNumericImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
