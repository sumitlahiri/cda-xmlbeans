 ...
 */
public class POCDMT000040CustodianImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Custodian
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040CustodianImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ASSIGNEDCUSTODIAN$6 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "assignedCustodian");
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040AssignedCustodian getAssignedCustodian()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040AssignedCustodian target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040AssignedCustodian)get_store().find_element_user(ASSIGNEDCUSTODIAN$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAssignedCustodian(com.walgreens.rxit.ch.cda.POCDMT000040AssignedCustodian assignedCustodian)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040AssignedCustodian)get_store().add_element_user(ASSIGNEDCUSTODIAN$6);
            }
            target.set(assignedCustodian);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040AssignedCustodian addNewAssignedCustodian()
    {
        synchronized (monitor())
        {
            check_orphaned();
