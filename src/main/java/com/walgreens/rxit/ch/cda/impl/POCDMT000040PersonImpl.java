 ...
 */
public class POCDMT000040PersonImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Person
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040PersonImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public com.walgreens.rxit.ch.cda.EntityClass xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.EntityClass)get_store().find_attribute_user(CLASSCODE$10);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityClass)get_default_attribute_value(CLASSCODE$10);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(com.walgreens.rxit.ch.cda.EntityClass classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityClass)get_store().add_attribute_user(CLASSCODE$10);
            }
    ...
    public com.walgreens.rxit.ch.cda.EntityDeterminer xgetDeterminerCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.EntityDeterminer)get_store().find_attribute_user(DETERMINERCODE$12);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityDeterminer)get_default_attribute_value(DETERMINERCODE$12);
            }
            return target;
        }
    }
    ...
    public boolean isSetDeterminerCode()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(DETERMINERCODE$12) != null;
        }
    }
    ...
    public void xsetDeterminerCode(com.walgreens.rxit.ch.cda.EntityDeterminer determinerCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityDeterminer)get_store().add_attribute_user(DETERMINERCODE$12);
            }
    ...
    public void unsetDeterminerCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(DETERMINERCODE$12);
        }
    }
}
