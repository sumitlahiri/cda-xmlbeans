 ...
 */
public class POCDMT000040Performer2Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Performer2
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040Performer2Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.ParticipationPhysicalPerformer.Enum getTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (com.walgreens.rxit.ch.cda.ParticipationPhysicalPerformer.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.ParticipationPhysicalPerformer xgetTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.ParticipationPhysicalPerformer target = null;
            target = (com.walgreens.rxit.ch.cda.ParticipationPhysicalPerformer)get_store().find_attribute_user(TYPECODE$14);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ParticipationPhysicalPerformer)get_default_attribute_value(TYPECODE$14);
            }
            return target;
        }
    }
     ...
     */
    public void setTypeCode(com.walgreens.rxit.ch.cda.ParticipationPhysicalPerformer.Enum typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTypeCode(com.walgreens.rxit.ch.cda.ParticipationPhysicalPerformer typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ParticipationPhysicalPerformer)get_store().add_attribute_user(TYPECODE$14);
            }
            target.set(typeCode);
        }
    }
