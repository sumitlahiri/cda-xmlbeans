 ...
 */
public class POCDMT000040BirthplaceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Birthplace
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040BirthplaceImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Place getPlace()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040Place target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040Place)get_store().find_element_user(PLACE$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPlace(com.walgreens.rxit.ch.cda.POCDMT000040Place place)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040Place)get_store().add_element_user(PLACE$6);
            }
            target.set(place);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Place addNewPlace()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public com.walgreens.rxit.ch.cda.RoleClass xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.RoleClass)get_store().find_attribute_user(CLASSCODE$10);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.RoleClass)get_default_attribute_value(CLASSCODE$10);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(com.walgreens.rxit.ch.cda.RoleClass classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.RoleClass)get_store().add_attribute_user(CLASSCODE$10);
            }
