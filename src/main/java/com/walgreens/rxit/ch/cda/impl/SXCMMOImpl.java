 ...
 */
public class SXCMMOImpl extends com.walgreens.rxit.ch.cda.impl.MOImpl implements com.walgreens.rxit.ch.cda.SXCMMO
{
    private static final long serialVersionUID = 1L;
    
    public SXCMMOImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
