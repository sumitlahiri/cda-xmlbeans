 ...
 */
public class RTOPQPQImpl extends com.walgreens.rxit.ch.cda.impl.QTYImpl implements com.walgreens.rxit.ch.cda.RTOPQPQ
{
    private static final long serialVersionUID = 1L;
    
    public RTOPQPQImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.PQ getNumerator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.PQ target = null;
            target = (com.walgreens.rxit.ch.cda.PQ)get_store().find_element_user(NUMERATOR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setNumerator(com.walgreens.rxit.ch.cda.PQ numerator)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.PQ)get_store().add_element_user(NUMERATOR$0);
            }
     ...
     */
    public com.walgreens.rxit.ch.cda.PQ addNewNumerator()
    {
        synchronized (monitor())
        {
            check_orphaned();
