 ...
 */
public class POCDMT000040Informant12Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Informant12
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040Informant12Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ASSIGNEDENTITY$6 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "assignedEntity");
    private static final javax.xml.namespace.QName RELATEDENTITY$8 = 
    ...
    public com.walgreens.rxit.ch.cda.POCDMT000040AssignedEntity getAssignedEntity()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.POCDMT000040AssignedEntity)get_store().find_element_user(ASSIGNEDENTITY$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetAssignedEntity()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ASSIGNEDENTITY$6) != 0;
        }
    }
    ...
    public void setAssignedEntity(com.walgreens.rxit.ch.cda.POCDMT000040AssignedEntity assignedEntity)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040AssignedEntity)get_store().add_element_user(ASSIGNEDENTITY$6);
            }
    ...
    public void unsetAssignedEntity()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ASSIGNEDENTITY$6, 0);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040RelatedEntity getRelatedEntity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040RelatedEntity target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040RelatedEntity)get_store().find_element_user(RELATEDENTITY$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetRelatedEntity()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(RELATEDENTITY$8) != 0;
        }
    }
     ...
     */
    public void setRelatedEntity(com.walgreens.rxit.ch.cda.POCDMT000040RelatedEntity relatedEntity)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040RelatedEntity)get_store().add_element_user(RELATEDENTITY$8);
            }
            target.set(relatedEntity);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040RelatedEntity addNewRelatedEntity()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetRelatedEntity()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(RELATEDENTITY$8, 0);
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.ParticipationType xgetTypeCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.ParticipationType)get_store().find_attribute_user(TYPECODE$12);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ParticipationType)get_default_attribute_value(TYPECODE$12);
            }
            return target;
        }
    }
    ...
    public void xsetTypeCode(com.walgreens.rxit.ch.cda.ParticipationType typeCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ParticipationType)get_store().add_attribute_user(TYPECODE$12);
            }
            target.set(typeCode);
        }
    }
