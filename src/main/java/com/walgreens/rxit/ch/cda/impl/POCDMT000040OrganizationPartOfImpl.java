 ...
 */
public class POCDMT000040OrganizationPartOfImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040OrganizationPartOf
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040OrganizationPartOfImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName WHOLEORGANIZATION$14 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "wholeOrganization");
    ...
    public boolean isSetStatusCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(STATUSCODE$10) != 0;
        }
    }
    ...
    public void unsetStatusCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(STATUSCODE$10, 0);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Organization getWholeOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040Organization target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040Organization)get_store().find_element_user(WHOLEORGANIZATION$14, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public boolean isSetWholeOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(WHOLEORGANIZATION$14) != 0;
        }
    }
     ...
     */
    public void setWholeOrganization(com.walgreens.rxit.ch.cda.POCDMT000040Organization wholeOrganization)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040Organization)get_store().add_element_user(WHOLEORGANIZATION$14);
            }
            target.set(wholeOrganization);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Organization addNewWholeOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void unsetWholeOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(WHOLEORGANIZATION$14, 0);
        }
    }
