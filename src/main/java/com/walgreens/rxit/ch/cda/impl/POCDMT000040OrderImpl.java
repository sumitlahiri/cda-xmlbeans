 ...
 */
public class POCDMT000040OrderImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Order
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040OrderImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName PRIORITYCODE$10 = 
    ...
    public com.walgreens.rxit.ch.cda.CE getPriorityCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.CE target = null;
            target = (com.walgreens.rxit.ch.cda.CE)get_store().find_element_user(PRIORITYCODE$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetPriorityCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PRIORITYCODE$10) != 0;
        }
    }
    ...
    public void setPriorityCode(com.walgreens.rxit.ch.cda.CE priorityCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.CE)get_store().add_element_user(PRIORITYCODE$10);
            }
    ...
    public void unsetPriorityCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(PRIORITYCODE$10, 0);
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.ActClassRoot xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.ActClassRoot)get_store().find_attribute_user(CLASSCODE$14);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ActClassRoot)get_default_attribute_value(CLASSCODE$14);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(com.walgreens.rxit.ch.cda.ActClassRoot classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ActClassRoot)get_store().add_attribute_user(CLASSCODE$14);
            }
