 ...
 */
public class PPDPQImpl extends com.walgreens.rxit.ch.cda.impl.PQImpl implements com.walgreens.rxit.ch.cda.PPDPQ
{
    private static final long serialVersionUID = 1L;
    
    public PPDPQImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
