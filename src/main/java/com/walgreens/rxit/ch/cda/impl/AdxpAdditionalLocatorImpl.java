 ...
 */
public class AdxpAdditionalLocatorImpl extends com.walgreens.rxit.ch.cda.impl.ADXPImpl implements com.walgreens.rxit.ch.cda.AdxpAdditionalLocator
{
    private static final long serialVersionUID = 1L;
    
    public AdxpAdditionalLocatorImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
