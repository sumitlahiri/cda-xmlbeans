 ...
 */
public class POCDMT000040Performer1Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Performer1
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040Performer1Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName FUNCTIONCODE$6 = 
    ...
    private static final javax.xml.namespace.QName ASSIGNEDENTITY$10 = 
     ...
     */
    public com.walgreens.rxit.ch.cda.CE getFunctionCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.CE target = null;
            target = (com.walgreens.rxit.ch.cda.CE)get_store().find_element_user(FUNCTIONCODE$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetFunctionCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(FUNCTIONCODE$6) != 0;
        }
    }
     ...
     */
    public void setFunctionCode(com.walgreens.rxit.ch.cda.CE functionCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.CE)get_store().add_element_user(FUNCTIONCODE$6);
            }
            target.set(functionCode);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.CE addNewFunctionCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetFunctionCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(FUNCTIONCODE$6, 0);
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.IVLTS getTime()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.IVLTS)get_store().find_element_user(TIME$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setTime(com.walgreens.rxit.ch.cda.IVLTS time)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.IVLTS)get_store().add_element_user(TIME$8);
            }
            target.set(time);
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.POCDMT000040AssignedEntity getAssignedEntity()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.POCDMT000040AssignedEntity)get_store().find_element_user(ASSIGNEDENTITY$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setAssignedEntity(com.walgreens.rxit.ch.cda.POCDMT000040AssignedEntity assignedEntity)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040AssignedEntity)get_store().add_element_user(ASSIGNEDENTITY$10);
            }
     ...
     */
    public com.walgreens.rxit.ch.cda.XServiceEventPerformer.Enum getTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (com.walgreens.rxit.ch.cda.XServiceEventPerformer.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.XServiceEventPerformer xgetTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.XServiceEventPerformer target = null;
            target = (com.walgreens.rxit.ch.cda.XServiceEventPerformer)get_store().find_attribute_user(TYPECODE$14);
            return target;
        }
    }
     ...
     */
    public void setTypeCode(com.walgreens.rxit.ch.cda.XServiceEventPerformer.Enum typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTypeCode(com.walgreens.rxit.ch.cda.XServiceEventPerformer typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.XServiceEventPerformer)get_store().add_attribute_user(TYPECODE$14);
            }
            target.set(typeCode);
        }
    }
