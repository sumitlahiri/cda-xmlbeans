 ...
 */
public class POCDMT000040GuardianImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Guardian
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040GuardianImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName GUARDIANPERSON$14 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "guardianPerson");
    private static final javax.xml.namespace.QName GUARDIANORGANIZATION$16 = 
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Person getGuardianPerson()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040Person target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040Person)get_store().find_element_user(GUARDIANPERSON$14, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetGuardianPerson()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GUARDIANPERSON$14) != 0;
        }
    }
     ...
     */
    public void setGuardianPerson(com.walgreens.rxit.ch.cda.POCDMT000040Person guardianPerson)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040Person)get_store().add_element_user(GUARDIANPERSON$14);
            }
            target.set(guardianPerson);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Person addNewGuardianPerson()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetGuardianPerson()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GUARDIANPERSON$14, 0);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Organization getGuardianOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040Organization target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040Organization)get_store().find_element_user(GUARDIANORGANIZATION$16, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetGuardianOrganization()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GUARDIANORGANIZATION$16) != 0;
        }
    }
     ...
     */
    public void setGuardianOrganization(com.walgreens.rxit.ch.cda.POCDMT000040Organization guardianOrganization)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040Organization)get_store().add_element_user(GUARDIANORGANIZATION$16);
            }
            target.set(guardianOrganization);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Organization addNewGuardianOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetGuardianOrganization()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GUARDIANORGANIZATION$16, 0);
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.RoleClass xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.RoleClass)get_store().find_attribute_user(CLASSCODE$20);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.RoleClass)get_default_attribute_value(CLASSCODE$20);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(com.walgreens.rxit.ch.cda.RoleClass classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.RoleClass)get_store().add_attribute_user(CLASSCODE$20);
            }
