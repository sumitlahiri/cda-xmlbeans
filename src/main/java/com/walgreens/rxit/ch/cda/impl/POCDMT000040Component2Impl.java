 ...
 */
public class POCDMT000040Component2Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Component2
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040Component2Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName NONXMLBODY$6 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "nonXMLBody");
    private static final javax.xml.namespace.QName STRUCTUREDBODY$8 = 
    ...
    private static final javax.xml.namespace.QName CONTEXTCONDUCTIONIND$14 = 
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040NonXMLBody getNonXMLBody()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040NonXMLBody target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040NonXMLBody)get_store().find_element_user(NONXMLBODY$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetNonXMLBody()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(NONXMLBODY$6) != 0;
        }
    }
     ...
     */
    public void setNonXMLBody(com.walgreens.rxit.ch.cda.POCDMT000040NonXMLBody nonXMLBody)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040NonXMLBody)get_store().add_element_user(NONXMLBODY$6);
            }
            target.set(nonXMLBody);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040NonXMLBody addNewNonXMLBody()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetNonXMLBody()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(NONXMLBODY$6, 0);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040StructuredBody getStructuredBody()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040StructuredBody target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040StructuredBody)get_store().find_element_user(STRUCTUREDBODY$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetStructuredBody()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(STRUCTUREDBODY$8) != 0;
        }
    }
     ...
     */
    public void setStructuredBody(com.walgreens.rxit.ch.cda.POCDMT000040StructuredBody structuredBody)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040StructuredBody)get_store().add_element_user(STRUCTUREDBODY$8);
            }
            target.set(structuredBody);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040StructuredBody addNewStructuredBody()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetStructuredBody()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(STRUCTUREDBODY$8, 0);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.ActRelationshipHasComponent.Enum getTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (com.walgreens.rxit.ch.cda.ActRelationshipHasComponent.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.ActRelationshipHasComponent xgetTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.ActRelationshipHasComponent target = null;
            target = (com.walgreens.rxit.ch.cda.ActRelationshipHasComponent)get_store().find_attribute_user(TYPECODE$12);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ActRelationshipHasComponent)get_default_attribute_value(TYPECODE$12);
            }
            return target;
        }
    }
     ...
     */
    public void setTypeCode(com.walgreens.rxit.ch.cda.ActRelationshipHasComponent.Enum typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTypeCode(com.walgreens.rxit.ch.cda.ActRelationshipHasComponent typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ActRelationshipHasComponent)get_store().add_attribute_user(TYPECODE$12);
            }
            target.set(typeCode);
        }
    }
    ...
    public boolean getContextConductionInd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CONTEXTCONDUCTIONIND$14);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(CONTEXTCONDUCTIONIND$14);
            }
            if (target == null)
            {
                return false;
    ...
    public com.walgreens.rxit.ch.cda.Bl2 xgetContextConductionInd()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.Bl2)get_store().find_attribute_user(CONTEXTCONDUCTIONIND$14);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.Bl2)get_default_attribute_value(CONTEXTCONDUCTIONIND$14);
            }
            return target;
        }
    }
    ...
    public boolean isSetContextConductionInd()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(CONTEXTCONDUCTIONIND$14) != null;
        }
    }
    ...
    public void setContextConductionInd(boolean contextConductionInd)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CONTEXTCONDUCTIONIND$14);
            }
    ...
    public void xsetContextConductionInd(com.walgreens.rxit.ch.cda.Bl2 contextConductionInd)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.Bl2)get_store().add_attribute_user(CONTEXTCONDUCTIONIND$14);
            }
    ...
    public void unsetContextConductionInd()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(CONTEXTCONDUCTIONIND$14);
        }
    }
}
