 ...
 */
public class POCDMT000040Component4Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Component4
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040Component4Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName CONTEXTCONDUCTIONIND$32 = 
    ...
    public com.walgreens.rxit.ch.cda.ActRelationshipHasComponent.Enum getTypeCode()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(TYPECODE$30);
            }
            if (target == null)
            {
                return null;
    ...
    public com.walgreens.rxit.ch.cda.ActRelationshipHasComponent xgetTypeCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.ActRelationshipHasComponent)get_store().find_attribute_user(TYPECODE$30);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ActRelationshipHasComponent)get_default_attribute_value(TYPECODE$30);
            }
            return target;
        }
    }
    ...
    public boolean isSetTypeCode()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(TYPECODE$30) != null;
        }
    }
    ...
    public void xsetTypeCode(com.walgreens.rxit.ch.cda.ActRelationshipHasComponent typeCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ActRelationshipHasComponent)get_store().add_attribute_user(TYPECODE$30);
            }
            target.set(typeCode);
        }
    }
    ...
    public void unsetTypeCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(TYPECODE$30);
        }
    }
    ...
    public boolean getContextConductionInd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CONTEXTCONDUCTIONIND$32);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(CONTEXTCONDUCTIONIND$32);
            }
            if (target == null)
            {
                return false;
    ...
    public com.walgreens.rxit.ch.cda.Bl2 xgetContextConductionInd()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.Bl2)get_store().find_attribute_user(CONTEXTCONDUCTIONIND$32);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.Bl2)get_default_attribute_value(CONTEXTCONDUCTIONIND$32);
            }
            return target;
        }
    }
    ...
    public boolean isSetContextConductionInd()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(CONTEXTCONDUCTIONIND$32) != null;
        }
    }
    ...
    public void setContextConductionInd(boolean contextConductionInd)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CONTEXTCONDUCTIONIND$32);
            }
    ...
    public void xsetContextConductionInd(com.walgreens.rxit.ch.cda.Bl2 contextConductionInd)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.Bl2)get_store().add_attribute_user(CONTEXTCONDUCTIONIND$32);
            }
    ...
    public void unsetContextConductionInd()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(CONTEXTCONDUCTIONIND$32);
        }
    }
}
