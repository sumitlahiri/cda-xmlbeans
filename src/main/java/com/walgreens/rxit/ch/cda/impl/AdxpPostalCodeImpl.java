 ...
 */
public class AdxpPostalCodeImpl extends com.walgreens.rxit.ch.cda.impl.ADXPImpl implements com.walgreens.rxit.ch.cda.AdxpPostalCode
{
    private static final long serialVersionUID = 1L;
    
    public AdxpPostalCodeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
