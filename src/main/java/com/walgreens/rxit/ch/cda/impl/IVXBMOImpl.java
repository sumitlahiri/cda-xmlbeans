 ...
 */
public class IVXBMOImpl extends com.walgreens.rxit.ch.cda.impl.MOImpl implements com.walgreens.rxit.ch.cda.IVXBMO
{
    private static final long serialVersionUID = 1L;
    
    public IVXBMOImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
