 ...
 */
public class POCDMT000040AssignedEntityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040AssignedEntity
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040AssignedEntityImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName REPRESENTEDORGANIZATION$16 = 
    ...
    public com.walgreens.rxit.ch.cda.POCDMT000040Organization getRepresentedOrganization()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.POCDMT000040Organization)get_store().find_element_user(REPRESENTEDORGANIZATION$16, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetRepresentedOrganization()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(REPRESENTEDORGANIZATION$16) != 0;
        }
    }
    ...
    public void setRepresentedOrganization(com.walgreens.rxit.ch.cda.POCDMT000040Organization representedOrganization)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040Organization)get_store().add_element_user(REPRESENTEDORGANIZATION$16);
            }
    ...
    public void unsetRepresentedOrganization()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(REPRESENTEDORGANIZATION$16, 0);
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.RoleClassAssignedEntity xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.RoleClassAssignedEntity)get_store().find_attribute_user(CLASSCODE$20);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.RoleClassAssignedEntity)get_default_attribute_value(CLASSCODE$20);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(com.walgreens.rxit.ch.cda.RoleClassAssignedEntity classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.RoleClassAssignedEntity)get_store().add_attribute_user(CLASSCODE$20);
            }
