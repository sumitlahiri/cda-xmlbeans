/*
 * XML Type:  POCD_MT000040.Place
 * Namespace: urn:hl7-org:v3
 * Java type: com.walgreens.rxit.ch.cda.POCDMT000040Place
 *
 * Automatically generated - do not modify.
 */
package com.walgreens.rxit.ch.cda.impl;
/**
 * An XML POCD_MT000040.Place(@urn:hl7-org:v3).
 *
 * This is a complex type.
 */
public class POCDMT000040PlaceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Place
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040PlaceImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public com.walgreens.rxit.ch.cda.EN getName()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.EN)get_store().find_element_user(NAME$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setName(com.walgreens.rxit.ch.cda.EN name)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EN)get_store().add_element_user(NAME$6);
            }
            target.set(name);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.AD getAddr()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.AD target = null;
            target = (com.walgreens.rxit.ch.cda.AD)get_store().find_element_user(ADDR$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetAddr()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ADDR$8) != 0;
        }
    }
     ...
     */
    public void setAddr(com.walgreens.rxit.ch.cda.AD addr)
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetAddr()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ADDR$8, 0);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.EntityClassPlace.Enum getClassCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (com.walgreens.rxit.ch.cda.EntityClassPlace.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.EntityClassPlace xgetClassCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.EntityClassPlace target = null;
            target = (com.walgreens.rxit.ch.cda.EntityClassPlace)get_store().find_attribute_user(CLASSCODE$12);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityClassPlace)get_default_attribute_value(CLASSCODE$12);
            }
            return target;
        }
    }
     ...
     */
    public void setClassCode(com.walgreens.rxit.ch.cda.EntityClassPlace.Enum classCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetClassCode(com.walgreens.rxit.ch.cda.EntityClassPlace classCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityClassPlace)get_store().add_attribute_user(CLASSCODE$12);
            }
    ...
    public com.walgreens.rxit.ch.cda.EntityDeterminer xgetDeterminerCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.EntityDeterminer)get_store().find_attribute_user(DETERMINERCODE$14);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityDeterminer)get_default_attribute_value(DETERMINERCODE$14);
            }
            return target;
        }
    }
    ...
    public boolean isSetDeterminerCode()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(DETERMINERCODE$14) != null;
        }
    }
    ...
    public void xsetDeterminerCode(com.walgreens.rxit.ch.cda.EntityDeterminer determinerCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityDeterminer)get_store().add_attribute_user(DETERMINERCODE$14);
            }
    ...
    public void unsetDeterminerCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(DETERMINERCODE$14);
        }
    }
}
