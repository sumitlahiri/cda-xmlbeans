 ...
 */
public class POCDMT000040LabeledDrugImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040LabeledDrug
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040LabeledDrugImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public com.walgreens.rxit.ch.cda.EntityClassManufacturedMaterial xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.EntityClassManufacturedMaterial)get_store().find_attribute_user(CLASSCODE$12);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityClassManufacturedMaterial)get_default_attribute_value(CLASSCODE$12);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(com.walgreens.rxit.ch.cda.EntityClassManufacturedMaterial classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityClassManufacturedMaterial)get_store().add_attribute_user(CLASSCODE$12);
            }
    ...
    public com.walgreens.rxit.ch.cda.EntityDeterminerDetermined xgetDeterminerCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.EntityDeterminerDetermined)get_store().find_attribute_user(DETERMINERCODE$14);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityDeterminerDetermined)get_default_attribute_value(DETERMINERCODE$14);
            }
            return target;
        }
    }
    ...
    public void xsetDeterminerCode(com.walgreens.rxit.ch.cda.EntityDeterminerDetermined determinerCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityDeterminerDetermined)get_store().add_attribute_user(DETERMINERCODE$14);
            }
