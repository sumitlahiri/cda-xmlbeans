 ...
 */
public class StrucDocFootnoteImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.StrucDocFootnote
{
    ...
    public com.walgreens.rxit.ch.cda.StrucDocRenderMultiMedia getRenderMultiMediaArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.StrucDocRenderMultiMedia)get_store().find_element_user(RENDERMULTIMEDIA$10, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocRenderMultiMedia insertNewRenderMultiMedia(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.StrucDocRenderMultiMedia target = null;
            target = (com.walgreens.rxit.ch.cda.StrucDocRenderMultiMedia)get_store().insert_element_user(RENDERMULTIMEDIA$10, i);
            return target;
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocRenderMultiMedia addNewRenderMultiMedia()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.StrucDocRenderMultiMedia target = null;
            target = (com.walgreens.rxit.ch.cda.StrucDocRenderMultiMedia)get_store().add_element_user(RENDERMULTIMEDIA$10);
            return target;
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocParagraph getParagraphArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.StrucDocParagraph)get_store().find_element_user(PARAGRAPH$12, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocParagraph insertNewParagraph(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.StrucDocParagraph target = null;
            target = (com.walgreens.rxit.ch.cda.StrucDocParagraph)get_store().insert_element_user(PARAGRAPH$12, i);
            return target;
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocParagraph addNewParagraph()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.StrucDocParagraph target = null;
            target = (com.walgreens.rxit.ch.cda.StrucDocParagraph)get_store().add_element_user(PARAGRAPH$12);
            return target;
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocList getListArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.StrucDocList)get_store().find_element_user(LIST$14, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocList insertNewList(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.StrucDocList target = null;
            target = (com.walgreens.rxit.ch.cda.StrucDocList)get_store().insert_element_user(LIST$14, i);
            return target;
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocList addNewList()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.StrucDocList target = null;
            target = (com.walgreens.rxit.ch.cda.StrucDocList)get_store().add_element_user(LIST$14);
            return target;
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocTable getTableArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.StrucDocTable)get_store().find_element_user(TABLE$16, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocTable insertNewTable(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.StrucDocTable target = null;
            target = (com.walgreens.rxit.ch.cda.StrucDocTable)get_store().insert_element_user(TABLE$16, i);
            return target;
        }
    }
    ...
    public com.walgreens.rxit.ch.cda.StrucDocTable addNewTable()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.StrucDocTable target = null;
            target = (com.walgreens.rxit.ch.cda.StrucDocTable)get_store().add_element_user(TABLE$16);
            return target;
        }
    }
