 ...
 */
public class POCDMT000040InFulfillmentOfImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040InFulfillmentOf
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040InFulfillmentOfImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ORDER$6 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "order");
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Order getOrder()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040Order target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040Order)get_store().find_element_user(ORDER$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrder(com.walgreens.rxit.ch.cda.POCDMT000040Order order)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040Order)get_store().add_element_user(ORDER$6);
            }
            target.set(order);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Order addNewOrder()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.walgreens.rxit.ch.cda.ActRelationshipFulfills.Enum getTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (com.walgreens.rxit.ch.cda.ActRelationshipFulfills.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.ActRelationshipFulfills xgetTypeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.ActRelationshipFulfills target = null;
            target = (com.walgreens.rxit.ch.cda.ActRelationshipFulfills)get_store().find_attribute_user(TYPECODE$10);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ActRelationshipFulfills)get_default_attribute_value(TYPECODE$10);
            }
            return target;
        }
    }
     ...
     */
    public void setTypeCode(com.walgreens.rxit.ch.cda.ActRelationshipFulfills.Enum typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTypeCode(com.walgreens.rxit.ch.cda.ActRelationshipFulfills typeCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ActRelationshipFulfills)get_store().add_attribute_user(TYPECODE$10);
            }
            target.set(typeCode);
        }
    }
