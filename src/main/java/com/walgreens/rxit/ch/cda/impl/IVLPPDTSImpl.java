 ...
 */
public class IVLPPDTSImpl extends com.walgreens.rxit.ch.cda.impl.SXCMPPDTSImpl implements com.walgreens.rxit.ch.cda.IVLPPDTS
{
    private static final long serialVersionUID = 1L;
    
    public IVLPPDTSImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.IVXBPPDTS getLow()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.IVXBPPDTS target = null;
            target = (com.walgreens.rxit.ch.cda.IVXBPPDTS)get_store().find_element_user(LOW$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLow(com.walgreens.rxit.ch.cda.IVXBPPDTS low)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.IVXBPPDTS)get_store().add_element_user(LOW$0);
            }
            target.set(low);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.IVXBPPDTS addNewLow()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.walgreens.rxit.ch.cda.IVXBPPDTS getHigh()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.IVXBPPDTS target = null;
            target = (com.walgreens.rxit.ch.cda.IVXBPPDTS)get_store().find_element_user(HIGH$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHigh(com.walgreens.rxit.ch.cda.IVXBPPDTS high)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.IVXBPPDTS)get_store().add_element_user(HIGH$4);
            }
            target.set(high);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.IVXBPPDTS addNewHigh()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.walgreens.rxit.ch.cda.PPDTS getCenter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.PPDTS target = null;
            target = (com.walgreens.rxit.ch.cda.PPDTS)get_store().find_element_user(CENTER$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCenter(com.walgreens.rxit.ch.cda.PPDTS center)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.PPDTS)get_store().add_element_user(CENTER$6);
            }
            target.set(center);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.PPDTS addNewCenter()
    {
        synchronized (monitor())
        {
            check_orphaned();
