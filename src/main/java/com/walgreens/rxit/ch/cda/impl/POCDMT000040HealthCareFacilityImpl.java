 ...
 */
public class POCDMT000040HealthCareFacilityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040HealthCareFacility
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040HealthCareFacilityImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SERVICEPROVIDERORGANIZATION$12 = 
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Place getLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040Place target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040Place)get_store().find_element_user(LOCATION$10, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLocation(com.walgreens.rxit.ch.cda.POCDMT000040Place location)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040Place)get_store().add_element_user(LOCATION$10);
            }
            target.set(location);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Place addNewLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Organization getServiceProviderOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040Organization target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040Organization)get_store().find_element_user(SERVICEPROVIDERORGANIZATION$12, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetServiceProviderOrganization()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(SERVICEPROVIDERORGANIZATION$12) != 0;
        }
    }
     ...
     */
    public void setServiceProviderOrganization(com.walgreens.rxit.ch.cda.POCDMT000040Organization serviceProviderOrganization)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040Organization)get_store().add_element_user(SERVICEPROVIDERORGANIZATION$12);
            }
            target.set(serviceProviderOrganization);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040Organization addNewServiceProviderOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetServiceProviderOrganization()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(SERVICEPROVIDERORGANIZATION$12, 0);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.RoleClassServiceDeliveryLocation.Enum getClassCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (com.walgreens.rxit.ch.cda.RoleClassServiceDeliveryLocation.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.RoleClassServiceDeliveryLocation xgetClassCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.RoleClassServiceDeliveryLocation target = null;
            target = (com.walgreens.rxit.ch.cda.RoleClassServiceDeliveryLocation)get_store().find_attribute_user(CLASSCODE$16);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.RoleClassServiceDeliveryLocation)get_default_attribute_value(CLASSCODE$16);
            }
            return target;
        }
    }
     ...
     */
    public void setClassCode(com.walgreens.rxit.ch.cda.RoleClassServiceDeliveryLocation.Enum classCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetClassCode(com.walgreens.rxit.ch.cda.RoleClassServiceDeliveryLocation classCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.RoleClassServiceDeliveryLocation)get_store().add_attribute_user(CLASSCODE$16);
            }
