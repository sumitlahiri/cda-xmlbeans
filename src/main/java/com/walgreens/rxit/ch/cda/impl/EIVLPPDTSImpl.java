 ...
 */
public class EIVLPPDTSImpl extends com.walgreens.rxit.ch.cda.impl.SXCMPPDTSImpl implements com.walgreens.rxit.ch.cda.EIVLPPDTS
{
    private static final long serialVersionUID = 1L;
    
    public EIVLPPDTSImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.IVLPPDPQ getOffset()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.IVLPPDPQ target = null;
            target = (com.walgreens.rxit.ch.cda.IVLPPDPQ)get_store().find_element_user(OFFSET$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOffset(com.walgreens.rxit.ch.cda.IVLPPDPQ offset)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.IVLPPDPQ)get_store().add_element_user(OFFSET$2);
            }
            target.set(offset);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.IVLPPDPQ addNewOffset()
    {
        synchronized (monitor())
        {
            check_orphaned();
