 ...
 */
public class POCDMT000040AssignedCustodianImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040AssignedCustodian
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040AssignedCustodianImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName REPRESENTEDCUSTODIANORGANIZATION$6 = 
        new javax.xml.namespace.QName("urn:hl7-org:v3", "representedCustodianOrganization");
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040CustodianOrganization getRepresentedCustodianOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.POCDMT000040CustodianOrganization target = null;
            target = (com.walgreens.rxit.ch.cda.POCDMT000040CustodianOrganization)get_store().find_element_user(REPRESENTEDCUSTODIANORGANIZATION$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRepresentedCustodianOrganization(com.walgreens.rxit.ch.cda.POCDMT000040CustodianOrganization representedCustodianOrganization)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.POCDMT000040CustodianOrganization)get_store().add_element_user(REPRESENTEDCUSTODIANORGANIZATION$6);
            }
            target.set(representedCustodianOrganization);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.POCDMT000040CustodianOrganization addNewRepresentedCustodianOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public com.walgreens.rxit.ch.cda.RoleClassAssignedEntity xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.RoleClassAssignedEntity)get_store().find_attribute_user(CLASSCODE$10);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.RoleClassAssignedEntity)get_default_attribute_value(CLASSCODE$10);
            }
            return target;
        }
    }
    ...
    public boolean isSetClassCode()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(CLASSCODE$10) != null;
        }
    }
    ...
    public void xsetClassCode(com.walgreens.rxit.ch.cda.RoleClassAssignedEntity classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.RoleClassAssignedEntity)get_store().add_attribute_user(CLASSCODE$10);
            }
    ...
    public void unsetClassCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(CLASSCODE$10);
        }
    }
}
