 ...
 */
public class SXCMCDImpl extends com.walgreens.rxit.ch.cda.impl.CDImpl implements com.walgreens.rxit.ch.cda.SXCMCD
{
    private static final long serialVersionUID = 1L;
    
    public SXCMCDImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
