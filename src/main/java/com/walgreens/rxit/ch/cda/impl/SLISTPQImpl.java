 ...
 */
public class SLISTPQImpl extends com.walgreens.rxit.ch.cda.impl.ANYImpl implements com.walgreens.rxit.ch.cda.SLISTPQ
{
     ...
     */
    public com.walgreens.rxit.ch.cda.PQ getOrigin()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.PQ target = null;
            target = (com.walgreens.rxit.ch.cda.PQ)get_store().find_element_user(ORIGIN$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrigin(com.walgreens.rxit.ch.cda.PQ origin)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.PQ)get_store().add_element_user(ORIGIN$0);
            }
            target.set(origin);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.PQ addNewOrigin()
    {
        synchronized (monitor())
        {
            check_orphaned();
