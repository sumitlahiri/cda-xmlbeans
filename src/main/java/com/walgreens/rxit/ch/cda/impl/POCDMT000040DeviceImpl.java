 ...
 */
public class POCDMT000040DeviceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040Device
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040DeviceImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public com.walgreens.rxit.ch.cda.EntityClassDevice xgetClassCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.walgreens.rxit.ch.cda.EntityClassDevice)get_store().find_attribute_user(CLASSCODE$14);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityClassDevice)get_default_attribute_value(CLASSCODE$14);
            }
            return target;
        }
    }
    ...
    public void xsetClassCode(com.walgreens.rxit.ch.cda.EntityClassDevice classCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.EntityClassDevice)get_store().add_attribute_user(CLASSCODE$14);
            }
