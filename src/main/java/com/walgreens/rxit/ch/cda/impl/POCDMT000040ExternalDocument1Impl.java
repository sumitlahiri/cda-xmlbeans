 ...
 */
public class POCDMT000040ExternalDocument1Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.walgreens.rxit.ch.cda.POCDMT000040ExternalDocument1
{
    private static final long serialVersionUID = 1L;
    
    public POCDMT000040ExternalDocument1Impl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.ActClassDocument1 xgetClassCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.ActClassDocument1 target = null;
            target = (com.walgreens.rxit.ch.cda.ActClassDocument1)get_store().find_attribute_user(CLASSCODE$18);
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ActClassDocument1)get_default_attribute_value(CLASSCODE$18);
            }
            return target;
        }
    }
     ...
     */
    public void xsetClassCode(com.walgreens.rxit.ch.cda.ActClassDocument1 classCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.ActClassDocument1)get_store().add_attribute_user(CLASSCODE$18);
            }
