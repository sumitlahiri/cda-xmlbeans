 ...
 */
public class PIVLPPDTSImpl extends com.walgreens.rxit.ch.cda.impl.SXCMPPDTSImpl implements com.walgreens.rxit.ch.cda.PIVLPPDTS
{
    private static final long serialVersionUID = 1L;
    
    public PIVLPPDTSImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.IVLPPDTS getPhase()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.IVLPPDTS target = null;
            target = (com.walgreens.rxit.ch.cda.IVLPPDTS)get_store().find_element_user(PHASE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPhase(com.walgreens.rxit.ch.cda.IVLPPDTS phase)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.IVLPPDTS)get_store().add_element_user(PHASE$0);
            }
            target.set(phase);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.IVLPPDTS addNewPhase()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.walgreens.rxit.ch.cda.PPDPQ getPeriod()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.PPDPQ target = null;
            target = (com.walgreens.rxit.ch.cda.PPDPQ)get_store().find_element_user(PERIOD$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPeriod(com.walgreens.rxit.ch.cda.PPDPQ period)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.PPDPQ)get_store().add_element_user(PERIOD$2);
            }
            target.set(period);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.PPDPQ addNewPeriod()
    {
        synchronized (monitor())
        {
            check_orphaned();
