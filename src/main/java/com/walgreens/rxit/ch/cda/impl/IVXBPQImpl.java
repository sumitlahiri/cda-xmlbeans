 ...
 */
public class IVXBPQImpl extends com.walgreens.rxit.ch.cda.impl.PQImpl implements com.walgreens.rxit.ch.cda.IVXBPQ
{
    private static final long serialVersionUID = 1L;
    
    public IVXBPQImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
