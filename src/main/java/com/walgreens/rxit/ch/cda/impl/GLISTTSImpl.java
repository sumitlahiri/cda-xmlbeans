 ...
 */
public class GLISTTSImpl extends com.walgreens.rxit.ch.cda.impl.ANYImpl implements com.walgreens.rxit.ch.cda.GLISTTS
{
     ...
     */
    public com.walgreens.rxit.ch.cda.TS getHead()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.walgreens.rxit.ch.cda.TS target = null;
            target = (com.walgreens.rxit.ch.cda.TS)get_store().find_element_user(HEAD$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setHead(com.walgreens.rxit.ch.cda.TS head)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.walgreens.rxit.ch.cda.TS)get_store().add_element_user(HEAD$0);
            }
            target.set(head);
        }
    }
     ...
     */
    public com.walgreens.rxit.ch.cda.TS addNewHead()
    {
        synchronized (monitor())
        {
            check_orphaned();
